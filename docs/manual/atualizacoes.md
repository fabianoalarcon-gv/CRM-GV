...
À esquerda ficam os patches (versões), do mais recente pro mais antigo; clicando num patch, os itens de mudança dele aparecem à direita — cada item tem um tipo (Solicitação/Correção/Melhoria/Inclusão), o local do sistema afetado, a descrição, e opcionalmente o número de um chamado de suporte relacionado.
