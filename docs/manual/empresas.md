...
Só o **nome da empresa** é obrigatório; o resto (CNPJ, setor, origem do lead, endereço por CEP, site, observações) pode ser preenchido depois. O campo **Origem do Lead** ajuda a rastrear como esse cliente chegou até vocês (indicação, orgânico, etc.) e aparece depois nos indicadores de Captação do Dashboard.
